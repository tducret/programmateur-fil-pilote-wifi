...
/* SHT1106
  ...
  ssd1306_command(0x81);    //contract control
  ssd1306_command(0x80);    //128
  ssd1306_command(0xA1);    //set segment remap
  ssd1306_command(0xA6);    //normal / reverse
  ssd1306_command(0xA8);    //multiplex ratio
  ssd1306_command(0x3F);    //duty = 1/32
  ssd1306_command(0xad);    //set charge pump enable
  ssd1306_command(0x8b);     //    0x8a    Íâ¹©VCC
  ssd1306_command(0x30);    //0X30---0X33  set VPP   9V
  ssd1306_command(0xC8);    //Com scan direction
  ssd1306_command(0xD3);    //set display offset
  ssd1306_command(0x00);   //   0x20
  ssd1306_command(0xD5);    /:set osc division
  ssd1306_command(0x80);
  ssd1306_command(0xD9);    //set pre-charge period
  ssd1306_command(0x1f);    //0x22
  ssd1306_command(0xDA);    //set COM pins
  ssd1306_command(0x12);    //0x02 -- duanhang xianshi,0x12
  ...
  */
  ...
  ssd1306_command(SSD1306_DISPLAYON);           // on
